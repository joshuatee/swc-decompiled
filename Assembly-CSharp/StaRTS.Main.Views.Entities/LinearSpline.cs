...
namespace StaRTS.Main.Views.Entities
{
	public class LinearSpline
	{
		...
		protected internal LinearSpline(UIntPtr dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((LinearSpline)GCHandledObjects.GCHandleToObject(instance)).AddWayPoint(*(*(IntPtr*)args), *(*(IntPtr*)(args + 1)));
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((LinearSpline)GCHandledObjects.GCHandleToObject(instance)).AddWayPoint(*(*(IntPtr*)args), *(*(IntPtr*)(args + 1)), *(float*)(args + 2), *(float*)(args + 3));
			return -1L;
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			((LinearSpline)GCHandledObjects.GCHandleToObject(instance)).AddWayPoint(*(*(IntPtr*)args), *(*(IntPtr*)(args + 1)), *(float*)(args + 2), *(float*)(args + 3), (WaypointReached)GCHandledObjects.GCHandleToObject(args[4]), GCHandledObjects.GCHandleToObject(args[5]));
			return -1L;
		}

		public unsafe static long $Invoke3(long instance, long* args)
		{
			((LinearSpline)GCHandledObjects.GCHandleToObject(instance)).Start();
			return -1L;
		}
	}
}
