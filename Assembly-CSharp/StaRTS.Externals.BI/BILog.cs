...
namespace StaRTS.Externals.BI
{
	public class BILog
	{
		...
		public const string VALUE_ACTION_TAPJOY = "tapjoy";
		...
		public const string VALUE_CONTEXT_VIDEO_START = "video_start";

		public const string VALUE_CONTEXT_VIDEO_AD = "video_ad";

		public const string VALUE_CONTEXT_VIDEO_PLAY = "video_play";

		public const string VALUE_CONTEXT_VIDEO_END = "video_end";

		public const string VALUE_CONTEXT_VIDEO_FAIL = "video_fail";

		public const string VALUE_CONTEXT_HOLONET_CTA_BUTTON = "cta_button";

		public const string VALUE_CONTEXT_VIDEO_SHARE_SOCIAL = "video_socialshare";

		public const string VALUE_CONTEXT_VIDEO_SHARE_SQUAD = "video_squadshare";

		public const string VALUE_ACTION_VIDEO_SEARCH = "search";

		public const string VALUE_ACTION_VIDEO_SQUAD = "squad";

		public const string VALUE_ACTION_VIDEO_FEATURED = "featured";

		public const string VALUE_ACTION_VIDEO_HOLONET = "holonet";

		public const string VALUE_ACTION_VIDEO_POSTWATCH = "postwatch";

		public const string VALUE_ACTION_VIDEO_BROWSE = "browse";

		public const string VALUE_ACTION_VIDEO_ABANDON = "abandon_playback";
