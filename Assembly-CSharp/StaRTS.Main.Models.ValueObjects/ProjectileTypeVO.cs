...
{
	public class ProjectileTypeVO : IAssetVO, ISplashVO, IValueObject
	{
		...
		public void ReadRow(Row row)
		{
			...
			if (this.IsBeam)
			{
				...
				{
					Service.Get<Logger>().WarnFormat("Beam projectileLength too large ({0}) for {1} (max is {2})", new object[]
					{
