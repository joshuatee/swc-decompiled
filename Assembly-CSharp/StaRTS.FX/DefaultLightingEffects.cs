...
namespace StaRTS.FX
{
	public class DefaultLightingEffects : AbstractLightingEffects, IEventObserver
	{
		...
		{
			Service.Get<EventManager>().RegisterObserver(this, EventId.BuildingViewReady, EventPriority.BeforeDefault);
			Service.Get<EventManager>().RegisterObserver(this, EventId.GameStateChanged, EventPriority.BeforeDefault);
		}
