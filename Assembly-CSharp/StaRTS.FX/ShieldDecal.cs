...
namespace StaRTS.FX
{
	public class ShieldDecal : IViewFrameTimeObserver
	{
		...
		protected internal ShieldDecal(UIntPtr dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((ShieldDecal)GCHandledObjects.GCHandleToObject(instance)).OnViewFrameTime(*(float*)args);
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((ShieldDecal)GCHandledObjects.GCHandleToObject(instance)).StartFade();
			return -1L;
		}
	}
}
