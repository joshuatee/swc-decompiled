...
namespace StaRTS.Main.Views.UX.Screens
{
	public class FactionFlipConfirmationScreen : AlertScreen
	{
		...
		private void OnConfirmButtonClicked(UXButton button)
		{
			...
			{
				Service.Get<ServerPlayerPrefs>().SetPref(ServerPref.FactionFlippingSkipConfirmation, "1");
				Service.Get<ServerAPI>().Enqueue(new SetPrefsCommand(false));
			}
			this.Close(true);
			Service.Get<EventManager>().SendEvent(EventId.UIFactionFlipConfirmAction, "faction");
		}
		...
		public override void Close(object modalResult)
		{
			if (modalResult == null)
			{
				FactionFlipScreen highestLevelScreen = Service.Get<ScreenController>().GetHighestLevelScreen<FactionFlipScreen>();
				if (highestLevelScreen != null)
				{
					highestLevelScreen.Close(false);
				}
			}
			Service.Get<EventManager>().SendEvent(EventId.UIFactionFlipConfirmAction, "close");
			base.Close(modalResult);
		}

		protected internal FactionFlipConfirmationScreen(UIntPtr dummy) : base(dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((FactionFlipConfirmationScreen)GCHandledObjects.GCHandleToObject(instance)).Close(GCHandledObjects.GCHandleToObject(*args));
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((FactionFlipConfirmationScreen)GCHandledObjects.GCHandleToObject(instance)).OnBackButtonClicked((UXButton)GCHandledObjects.GCHandleToObject(*args));
			return -1L;
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			((FactionFlipConfirmationScreen)GCHandledObjects.GCHandleToObject(instance)).OnConfirmButtonClicked((UXButton)GCHandledObjects.GCHandleToObject(*args));
			return -1L;
		}

		public unsafe static long $Invoke3(long instance, long* args)
		{
			((FactionFlipConfirmationScreen)GCHandledObjects.GCHandleToObject(instance)).SetupControls();
			return -1L;
		}
	}
}
