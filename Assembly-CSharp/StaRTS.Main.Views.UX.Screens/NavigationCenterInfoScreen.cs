...
namespace StaRTS.Main.Views.UX.Screens
{
	public class NavigationCenterInfoScreen : BuildingInfoScreen
	{
		...
		protected override void InitButtons()
		{
			...
			bool enabled = Service.Get<BuildingLookupController>().HasNavigationCenter();
		...
		private void InitUnlockedPlanets()
		{
			...
			while (i < count)
			{
				...
				PlanetVO planetVO = dataController.Get<PlanetVO>(uid);
				...
				{
					subElement.Text = Service.Get<Lang>().Get("s_Current", new object[0]);
				}
