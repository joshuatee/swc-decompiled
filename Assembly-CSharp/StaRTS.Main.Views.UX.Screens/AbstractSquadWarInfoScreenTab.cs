...
namespace StaRTS.Main.Views.UX.Screens
{
	public class AbstractSquadWarInfoScreenTab
	{
		...
		protected internal AbstractSquadWarInfoScreenTab(UIntPtr dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((AbstractSquadWarInfoScreenTab)GCHandledObjects.GCHandleToObject(instance)).PopulateBgTexture(Marshal.PtrToStringUni(*(IntPtr*)args), Marshal.PtrToStringUni(*(IntPtr*)(args + 1)));
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((AbstractSquadWarInfoScreenTab)GCHandledObjects.GCHandleToObject(instance)).PopulateGrid((string[])GCHandledObjects.GCHandleToPinnedArrayObject(*args), Marshal.PtrToStringUni(*(IntPtr*)(args + 1)), Marshal.PtrToStringUni(*(IntPtr*)(args + 2)), Marshal.PtrToStringUni(*(IntPtr*)(args + 3)), Marshal.PtrToStringUni(*(IntPtr*)(args + 4)), Marshal.PtrToStringUni(*(IntPtr*)(args + 5)));
			return -1L;
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			((AbstractSquadWarInfoScreenTab)GCHandledObjects.GCHandleToObject(instance)).ShowContents(*(sbyte*)args != 0);
			return -1L;
		}

		public unsafe static long $Invoke3(long instance, long* args)
		{
			((AbstractSquadWarInfoScreenTab)GCHandledObjects.GCHandleToObject(instance)).TabButtonOnSelect((UXCheckbox)GCHandledObjects.GCHandleToObject(*args), *(sbyte*)(args + 1) != 0);
			return -1L;
		}
	}
}
