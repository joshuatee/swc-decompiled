...
namespace StaRTS.Main.Views.UX.Screens
{
	public class TargetedBundleRewardedConfirmScreen : ClosableScreen
	{
		...
		protected internal TargetedBundleRewardedConfirmScreen(UIntPtr dummy) : base(dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((TargetedBundleRewardedConfirmScreen)GCHandledObjects.GCHandleToObject(instance)).OnConfirmButtonClicked((UXButton)GCHandledObjects.GCHandleToObject(*args));
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((TargetedBundleRewardedConfirmScreen)GCHandledObjects.GCHandleToObject(instance)).OnScreenLoaded();
			return -1L;
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			((TargetedBundleRewardedConfirmScreen)GCHandledObjects.GCHandleToObject(instance)).UpdateElements();
			return -1L;
		}
	}
}
