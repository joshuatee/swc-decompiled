	...
	public class FactionIconCelebScreen : ScreenBase
	{
		...
		private void OnIconLoadComplete()
		{
			...
			if (componentInChildren != null)
			{
				...
				this.timerId = Service.Get<ViewTimerManager>().CreateViewTimer(8f, false, new TimerDelegate(this.OnAnimationFinishedTimer), null);
				return;
			}
			this.HideAndCloseCelebration();
		}

		protected internal FactionIconCelebScreen(UIntPtr dummy) : base(dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			return GCHandledObjects.ObjectToGCHandle(((FactionIconCelebScreen)GCHandledObjects.GCHandleToObject(instance)).WantTransitions);
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((FactionIconCelebScreen)GCHandledObjects.GCHandleToObject(instance)).HideAndCloseCelebration();
			return -1L;
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			((FactionIconCelebScreen)GCHandledObjects.GCHandleToObject(instance)).OnDestroyElement();
			return -1L;
		}

		public unsafe static long $Invoke3(long instance, long* args)
		{
			((FactionIconCelebScreen)GCHandledObjects.GCHandleToObject(instance)).OnIconLoadComplete();
			return -1L;
		}

		public unsafe static long $Invoke4(long instance, long* args)
		{
			((FactionIconCelebScreen)GCHandledObjects.GCHandleToObject(instance)).OnIconLoadFailed();
			return -1L;
		}

		public unsafe static long $Invoke5(long instance, long* args)
		{
			((FactionIconCelebScreen)GCHandledObjects.GCHandleToObject(instance)).OnScreenLoaded();
			return -1L;
		}
	}
}
