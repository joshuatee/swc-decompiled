...
namespace StaRTS.Main.Views.UX.Screens
{
	public class SquadWarStartScreen : ClosableScreen
	{
		...
		protected override void OnScreenLoaded()
		{
			...
			TextureVO optional = Service.Get<IDataController>().GetOptional<TextureVO>("gui_textures_squadwar_start");
			if (optional != null)
			{
		...
		private void LogMemberAttemptingWarStart()
		{
			...
			Service.Get<BILoggingController>().TrackGameAction(highestLevelHQ.ToString(), "UI_squadwar_askforwar", string.Concat(new object[]
			{
				squadID,
				"|",
				memberCount,
