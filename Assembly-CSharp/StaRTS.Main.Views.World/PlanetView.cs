...
namespace StaRTS.Main.Views.World
{
	public class PlanetView
	{
		...
		public void DrawWorldGrid()
		{
			...
			{
				Service.Get<AssetManager>().Load(ref this.gridAssetHandle, "visible_grid_plane", new AssetSuccessDelegate(this.OnGridSuccess), null, null);
			}
		}
		...
		public void DestroyWorldGrid()
		{
			if (this.gridAssetHandle != AssetHandle.Invalid)
			{
				...
				Service.Get<AssetManager>().Unload(this.gridAssetHandle);
