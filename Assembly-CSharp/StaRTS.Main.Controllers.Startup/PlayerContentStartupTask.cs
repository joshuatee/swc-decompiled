...
namespace StaRTS.Main.Controllers.Startup
{
	public class PlayerContentStartupTask : StartupTask
	{
		...
		protected internal PlayerContentStartupTask(UIntPtr dummy) : base(dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((PlayerContentStartupTask)GCHandledObjects.GCHandleToObject(instance)).OnAllPatchesComplete();
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((PlayerContentStartupTask)GCHandledObjects.GCHandleToObject(instance)).OnCommandComplete((GetContentResponse)GCHandledObjects.GCHandleToObject(*args), GCHandledObjects.GCHandleToObject(args[1]));
			return -1L;
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			((PlayerContentStartupTask)GCHandledObjects.GCHandleToObject(instance)).OnFmsComplete();
			return -1L;
		}

		public unsafe static long $Invoke3(long instance, long* args)
		{
			((PlayerContentStartupTask)GCHandledObjects.GCHandleToObject(instance)).OnFmsError();
			return -1L;
		}

		public unsafe static long $Invoke4(long instance, long* args)
		{
			((PlayerContentStartupTask)GCHandledObjects.GCHandleToObject(instance)).OnPatchComplete(*(sbyte*)args != 0, Marshal.PtrToStringUni(*(IntPtr*)(args + 1)));
			return -1L;
		}

		public unsafe static long $Invoke5(long instance, long* args)
		{
			((PlayerContentStartupTask)GCHandledObjects.GCHandleToObject(instance)).ProcessNextPatch();
			return -1L;
		}

		public unsafe static long $Invoke6(long instance, long* args)
		{
			((PlayerContentStartupTask)GCHandledObjects.GCHandleToObject(instance)).SetupStaticDataController();
			return -1L;
		}

		public unsafe static long $Invoke7(long instance, long* args)
		{
			((PlayerContentStartupTask)GCHandledObjects.GCHandleToObject(instance)).Start();
			return -1L;
		}
	}
}
