	...
	public class ConditionFactory
	{
		...
		public static AbstractCondition GenerateCondition(ConditionVO vo, IConditionParent parent, int startingValue)
		{
			...
			try
			{
				...
				Service.Get<Logger>().ErrorFormat("Unrecognized condition {0} in {1}", new object[]
				{
					vo.ConditionType,
					vo.Uid
				});
			...
			{
				Service.Get<Logger>().ErrorFormat("Invalid condition detected in uid {0}. {1}:{2}", new object[]
				{
					vo.Uid,
					vo.ConditionType,
					vo.PrepareString
