...
namespace StaRTS.Main.Views.UX.Screens.ScreenHelpers.Planets
{
	public class PlanetDetailsObjectivesViewModule : AbstractPlanetDetailsViewModule, IViewClockTimeObserver
	{
		...
		public void OnScreenLoaded()
		{
			...
			this.labelObjectivesTitle.Text = Service.Get<Lang>().Get("OBJECTIVES", new object[0]);
		...
		public void RefreshScreenForPlanetChange()
		{
			...
			ObjectiveSeriesVO objectiveSeriesVO = Service.Get<IDataController>().Get<ObjectiveSeriesVO>(objectiveGroup.GroupSeriesId);
			...
			if (objectiveSeriesVO.SpecialEvent)
			{
				...
				this.labelObjectivesTitle.Text = Service.Get<Lang>().Get(objectiveSeriesVO.ObjectiveString, new object[0]);
			}
			else
			{
				this.labelObjectivesTitle.Text = Service.Get<Lang>().Get("OBJECTIVES", new object[0]);
		...
		public void SendObjectiveDetailsClickedBiLog(PlanetVO planetVo)
		{
			...
			Service.Get<EventManager>().SendEvent(EventId.ObjectiveDetailsClicked, cookie);
		}
