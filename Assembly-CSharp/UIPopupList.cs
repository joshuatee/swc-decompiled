...
public class UIPopupList : UIWidgetContainer
{
	...
	{
		UIPopupList.<UpdateTweenPosition>c__Iterator2 <UpdateTweenPosition>c__Iterator = new UIPopupList.<UpdateTweenPosition>c__Iterator2();
	...
	{
		UIPopupList.<CloseIfUnselected>c__Iterator3 <CloseIfUnselected>c__Iterator = new UIPopupList.<CloseIfUnselected>c__Iterator3();
