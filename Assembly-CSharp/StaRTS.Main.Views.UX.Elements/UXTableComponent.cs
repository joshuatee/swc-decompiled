...
namespace StaRTS.Main.Views.UX.Elements
{
	public class UXTableComponent : AbstractUXListComponent
	{
		...
		{
			UXTableComponent.<DelayedReposition>c__Iterator1D <DelayedReposition>c__Iterator1D = new UXTableComponent.<DelayedReposition>c__Iterator1D();
			<DelayedReposition>c__Iterator1D.<>f__this = this;
			return <DelayedReposition>c__Iterator1D;
		}
