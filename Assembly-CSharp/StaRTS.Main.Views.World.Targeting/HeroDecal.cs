...
namespace StaRTS.Main.Views.World.Targeting
{
	public class HeroDecal : IViewFrameTimeObserver
	{
		...
		public HeroDecal(Entity entity)
		{
			...
			this.hero = Service.Get<IDataController>().Get<TroopTypeVO>(uid);
			this.name = string.Format("HeroDecal {0}", new object[]
			{
				this.hero.Uid
			});
			...
			{
				Service.Get<AssetManager>().Load(ref this.heroHandle, this.hero.DecalAssetName, new AssetSuccessDelegate(this.OnLoad), null, null);
			}
		}
		...
		protected internal HeroDecal(UIntPtr dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((HeroDecal)GCHandledObjects.GCHandleToObject(instance)).Cleanup();
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((HeroDecal)GCHandledObjects.GCHandleToObject(instance)).FadeToGray();
			return -1L;
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			return GCHandledObjects.ObjectToGCHandle(((HeroDecal)GCHandledObjects.GCHandleToObject(instance)).Entity);
		}

		public unsafe static long $Invoke3(long instance, long* args)
		{
			((HeroDecal)GCHandledObjects.GCHandleToObject(instance)).OnLoad(GCHandledObjects.GCHandleToObject(*args), GCHandledObjects.GCHandleToObject(args[1]));
			return -1L;
		}

		public unsafe static long $Invoke4(long instance, long* args)
		{
			((HeroDecal)GCHandledObjects.GCHandleToObject(instance)).OnViewFrameTime(*(float*)args);
			return -1L;
		}

		public unsafe static long $Invoke5(long instance, long* args)
		{
			((HeroDecal)GCHandledObjects.GCHandleToObject(instance)).Entity = (Entity)GCHandledObjects.GCHandleToObject(*args);
			return -1L;
		}

		public unsafe static long $Invoke6(long instance, long* args)
		{
			((HeroDecal)GCHandledObjects.GCHandleToObject(instance)).SetMaterialSaturation(*(float*)args);
			return -1L;
		}
		...
		{
			return GCHandledObjects.ObjectToGCHandle(((HeroDecal)GCHandledObjects.GCHandleToObject(instance)).TrySetMaterial());
		}

		public unsafe static long $Invoke9(long instance, long* args)
		{
			((HeroDecal)GCHandledObjects.GCHandleToObject(instance)).TrySetupView();
			return -1L;
		}
	}
}
