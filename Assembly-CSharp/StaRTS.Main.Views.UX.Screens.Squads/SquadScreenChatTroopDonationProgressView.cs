...
namespace StaRTS.Main.Views.UX.Screens.Squads
{
	public class SquadScreenChatTroopDonationProgressView : AbstractSquadScreenViewModule, IEventObserver, IViewClockTimeObserver
	{
		...
		protected internal SquadScreenChatTroopDonationProgressView(UIntPtr dummy) : base(dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((SquadScreenChatTroopDonationProgressView)GCHandledObjects.GCHandleToObject(instance)).HideView();
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((SquadScreenChatTroopDonationProgressView)GCHandledObjects.GCHandleToObject(instance)).OnDestroyElement();
			return -1L;
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			return GCHandledObjects.ObjectToGCHandle(((SquadScreenChatTroopDonationProgressView)GCHandledObjects.GCHandleToObject(instance)).OnEvent((EventId)(*(int*)args), GCHandledObjects.GCHandleToObject(args[1])));
		}

		public unsafe static long $Invoke3(long instance, long* args)
		{
			((SquadScreenChatTroopDonationProgressView)GCHandledObjects.GCHandleToObject(instance)).OnScreenLoaded();
			return -1L;
		}

		public unsafe static long $Invoke4(long instance, long* args)
		{
			((SquadScreenChatTroopDonationProgressView)GCHandledObjects.GCHandleToObject(instance)).OnViewClockTime(*(float*)args);
			return -1L;
		}

		public unsafe static long $Invoke5(long instance, long* args)
		{
			((SquadScreenChatTroopDonationProgressView)GCHandledObjects.GCHandleToObject(instance)).RefreshTroopDonationProgress();
			return -1L;
		}

		public unsafe static long $Invoke6(long instance, long* args)
		{
			((SquadScreenChatTroopDonationProgressView)GCHandledObjects.GCHandleToObject(instance)).ShowView();
			return -1L;
		}

		public unsafe static long $Invoke7(long instance, long* args)
		{
			((SquadScreenChatTroopDonationProgressView)GCHandledObjects.GCHandleToObject(instance)).UpdateCountDownTimer();
			return -1L;
		}

		public unsafe static long $Invoke8(long instance, long* args)
		{
			((SquadScreenChatTroopDonationProgressView)GCHandledObjects.GCHandleToObject(instance)).UpdateInProgress();
			return -1L;
		}
	}
}
