...
namespace StaRTS.Main.Views.UX.Screens.Squads
{
	public class SquadLevelUpCelebrationScreen : ClosableScreen
	{
		...
		protected override void OnScreenLoaded()
		{
			...
			Service.Get<EventManager>().SendEvent(EventId.SquadLeveledUpCelebration, null);
		}
		...
		protected internal SquadLevelUpCelebrationScreen(UIntPtr dummy) : base(dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((SquadLevelUpCelebrationScreen)GCHandledObjects.GCHandleToObject(instance)).AddUnlockedPerksToGrid();
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			((SquadLevelUpCelebrationScreen)GCHandledObjects.GCHandleToObject(instance)).AddUnlockedSlotsToGrid();
			return -1L;
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			return GCHandledObjects.ObjectToGCHandle(((SquadLevelUpCelebrationScreen)GCHandledObjects.GCHandleToObject(instance)).WantTransitions);
		}

		public unsafe static long $Invoke3(long instance, long* args)
		{
			((SquadLevelUpCelebrationScreen)GCHandledObjects.GCHandleToObject(instance)).OnContinueClicked((UXButton)GCHandledObjects.GCHandleToObject(*args));
			return -1L;
		}

		public unsafe static long $Invoke4(long instance, long* args)
		{
			((SquadLevelUpCelebrationScreen)GCHandledObjects.GCHandleToObject(instance)).OnDestroyElement();
			return -1L;
		}

		public unsafe static long $Invoke5(long instance, long* args)
		{
			((SquadLevelUpCelebrationScreen)GCHandledObjects.GCHandleToObject(instance)).OnScreenLoaded();
			return -1L;
		}
	}
}
