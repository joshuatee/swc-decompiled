	...
	public class SquadTroopRequestScreen : AbstractSquadRequestScreen, IViewClockTimeObserver, IEventObserver
	{
		...
		protected override void OnScreenLoaded()
		{
			...
			if (this.isWarRequest)
			{
				...
				Service.Get<EventManager>().RegisterObserver(this, EventId.CurrentPlayerMemberDataUpdated);
			}
		...
		{
			base.InitButtons();
			Entity currentSquadBuilding = Service.Get<BuildingLookupController>().GetCurrentSquadBuilding();
		...
		protected override void OnClicked(UXButton button)
		{
			...
			Service.Get<SquadController>().SendTroopRequest(text, this.isWarRequest);
			this.Close(null);
		}
		...
		public override void OnDestroyElement()
		{
			...
			Service.Get<EventManager>().UnregisterObserver(this, EventId.CurrentPlayerMemberDataUpdated);
