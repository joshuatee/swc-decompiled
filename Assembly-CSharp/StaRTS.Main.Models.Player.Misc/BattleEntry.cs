...
namespace StaRTS.Main.Models.Player.Misc
{
	public class BattleEntry : ISerializable
	{
		...
		public ISerializable FromObject(object obj)
		{
			...
			this.BattleVersion = ((!dictionary.ContainsKey("battleVersion")) ? "22.0".ToString() : Convert.ToString(dictionary["battleVersion"]));
			this.CmsVersion = ((!dictionary.ContainsKey("cmsVersion")) ? Service.Get<FMS>().GetFileVersion("patches/base.json").ToString() : Convert.ToString(dictionary["cmsVersion"]));
