...
namespace StaRTS.Externals.IAP
{
	public class AndroidIAPManager : IInAppPurchaseManager
	{
		...
		public void RestorePurchases()
		{
			...
			Service.Get<Logger>().Debug("RestorePurchases: " + flag);
		}
