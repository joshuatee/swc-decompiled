...
namespace StaRTS.Main.Views.Animations
{
	public class TextCrawlAnimation : UXFactory, IViewFrameTimeObserver, IUserInputObserver, IBackButtonHandler
	{
		...
		protected internal TextCrawlAnimation(UIntPtr dummy) : base(dummy)
		{
		}

		public unsafe static long $Invoke0(long instance, long* args)
		{
			((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).FinishUp(*(sbyte*)args != 0);
			return -1L;
		}

		public unsafe static long $Invoke1(long instance, long* args)
		{
			return GCHandledObjects.ObjectToGCHandle(((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).HandleBackButtonPress());
		}

		public unsafe static long $Invoke2(long instance, long* args)
		{
			((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).Loaded(GCHandledObjects.GCHandleToObject(*args));
			return -1L;
		}

		public unsafe static long $Invoke3(long instance, long* args)
		{
			return GCHandledObjects.ObjectToGCHandle(((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).OnDrag(*(int*)args, (GameObject)GCHandledObjects.GCHandleToObject(args[1]), *(*(IntPtr*)(args + 2)), *(*(IntPtr*)(args + 3))));
		}

		public unsafe static long $Invoke4(long instance, long* args)
		{
			return GCHandledObjects.ObjectToGCHandle(((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).OnPress(*(int*)args, (GameObject)GCHandledObjects.GCHandleToObject(args[1]), *(*(IntPtr*)(args + 2)), *(*(IntPtr*)(args + 3))));
		}

		public unsafe static long $Invoke5(long instance, long* args)
		{
			return GCHandledObjects.ObjectToGCHandle(((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).OnRelease(*(int*)args));
		}

		public unsafe static long $Invoke6(long instance, long* args)
		{
			return GCHandledObjects.ObjectToGCHandle(((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).OnScroll(*(float*)args, *(*(IntPtr*)(args + 1))));
		}

		public unsafe static long $Invoke7(long instance, long* args)
		{
			((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).OnViewFrameTime(*(float*)args);
			return -1L;
		}

		public unsafe static long $Invoke8(long instance, long* args)
		{
			((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).OnWipeComplete();
			return -1L;
		}

		public unsafe static long $Invoke9(long instance, long* args)
		{
			((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).Start();
			return -1L;
		}

		public unsafe static long $Invoke10(long instance, long* args)
		{
			((TextCrawlAnimation)GCHandledObjects.GCHandleToObject(instance)).StopNow();
			return -1L;
		}
	}
}
